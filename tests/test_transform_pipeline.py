...
def test_datamodule_simple_transforms():
    ...
    data = AutoDataModule(
        dataset=CIFAR10("data", train=True, download=True), transforms=transform, target_transforms=target_transform
    )
...
def test_datamodule_dict_transforms():
    ...
    target_transforms_dict = {"train": SimpleTargetTransform(10), "val": SimpleTargetTransform(20)}
...
def test_datamodule_pre_loaded_transforms():
    ...
    transforms_dict = {"pre_load": SimpleTransform(1), "train": SimpleTransform(2)}

    data = AutoDataModule(dataset=CIFAR10("data", train=True, download=True), transforms=transforms_dict, pre_load=True)
...
def test_pre_load_target_transforms():
    ...
    target_transforms_dict = {"pre_load": SimpleTargetTransform(5), "train": SimpleTargetTransform(10)}
...
def test_pre_and_post_transforms_only():
    ...
    transforms_dict = {"pre": SimpleTransform(2), "post": SimpleTransform(3)}

    target_transforms_dict = {"pre": SimpleTargetTransform(5), "post": SimpleTargetTransform(7)}
...
def test_multiple_pre_post_transforms():
    ...
    data = AutoDataModule(dataset=CIFAR10("data", train=True, download=True), transforms=transforms_dict)
...
def test_batch_transforms():
    ...
    batch_transforms = {"before": SimpleTransform(5), "after": SimpleTransform(10)}

    data = AutoDataModule(dataset=None, batch_transforms=batch_transforms, target_batch_transforms=None)
...
def test_batch_and_target_batch_transforms():
    ...
    target_batch_transforms = {"before": SimpleTargetTransform(1), "after": SimpleTargetTransform(2)}

    data = AutoDataModule(
        dataset=None, batch_transforms=batch_transforms, target_batch_transforms=target_batch_transforms
    )
...
def test_combined_target_batch_transforms():
    ...
    data = AutoDataModule(dataset=None, batch_transforms=batch_transforms, target_batch_transforms="combine")
...
def test_phase_specific_pre_load():
    ...
    transforms_dict = {"pre_load": SimpleTransform(1), "train": SimpleTransform(2), "val": SimpleTransform(8)}
